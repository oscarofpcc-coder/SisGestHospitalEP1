...
namespace SisGestionCitasMedicas
{
    public class DoctoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DoctorId,Nombre,Apellido,Especialidad,Telefono")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DoctorId,Nombre,Apellido,Especialidad,Telefono")] Doctor doctor)
        {
